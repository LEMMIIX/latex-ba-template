...
\input{resources/settings/macros}
...
\lstdefinelanguage{Java}{
  keywords={typeof, new, true, false, catch, function, return, null, catch, switch, var, if, while, do, else, case, break, this, const},
...
% Deckblatt ohne sichtbare Seitenzahl, aber als erste Seite mitgezählt
...
%die ersten Seiten vor dem tatsächlichen Text werden römisch nummeriert
\pagenumbering{Roman}

% Abstract und Verzeichnisse
\input{chapter/0_Kurzfassung.tex}
\newpage
...
\listoffigures
\newpage
\input{chapter/KI_Verzeichnis.tex}
\newpage

% Kapitel ab hier arabisch nummerieren
\pagenumbering{arabic}

%TODO WICHTIG entferne die folgenden Zeilen wenn du ready für den Druck bist...
\listoftodos
\todo{entfernen sobald fertig für Druck}
\newpage
%... denn es wäre peinlich deine Todos im fertigen Druck zu sehen
